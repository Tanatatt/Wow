...
const element = document.getElementById("imgsss");
...
// when the user click the search button and the error appears, the picture of "invalid location" will fade in
...
// If the weather is sunny, the picture shows the sunny image, and again with others weather
            switch (json.weather[0].main) {
                ...
                case 'Rain':
                    image.src = 'picture/rainny.png';
                    break;

                case 'Snow':
                    image.src = 'picture/winter.png';
                    break;

                case 'Clouds':
                    image.src = 'picture/cloudy.png';
...
// Input information and the website suggests the country
  ...
  // All countries that listed for this function
